...
class ReadingLessonRandomizedIndex {
    protected ArrayList<Integer> index_list = new ArrayList<Integer>();
    protected ArrayList<ReadingLessonCard> deck;
    protected boolean are_cards_removable;

    public ReadingLessonRandomizedIndex(ArrayList<ReadingLessonCard> deck, boolean are_card_removable) {
        this.deck = deck;
        this.are_cards_removable = are_card_removable;
        ResetList();
    }
    ...
    public void ResetList() {
        ...
        for (int i = 0; i < deck.size(); i++) {
            int questions_left = deck.get(i).getCardsRepeatCount();
